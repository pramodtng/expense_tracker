      ...
      <div className="w-full max-w-sm">
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <p className="text-sm text-emerald-700">Start managing your finances today</p>
          </div>
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl">Create an account</CardTitle>
              <CardDescription>Enter your email to get started with your budget tracker</CardDescription>
            </CardHeader>
            <CardContent>
